    ...
    <View className="flex-1 relative">
      ...
      {loading ? (
        <View className="flex-1 flex-row justify-center items-center">
          ...
          <Progress.CircleSnail thickness={10} size={140} color="#f9a8d4" />
        </View>
      ) : (
        <SafeAreaView className="flex flex-1" style={{ paddingTop: 50 }}>
          {/* search section */}
          <View style={{ height: "7%" }} className="mx-4 relative z-50">
            ...
            >
              ...
              >
                <MagnifyingGlassIcon size="25" color="white" strokeWidth="3" />
              </TouchableOpacity>
            </View>
          ...
          <View className="mb-2 space-y-3">
            ...
            >
              {weather?.forecast?.forecastday?.map((item, index) => {
                ...
                {
                  /* console.log(item?.day?.condition?.text + " ", item?.date); */
                }
                return (
                  <View
                    key={index}
